...
describe("blacklisted contract deployment", () => {
  ...
  const createTxEvent = (deployer, contractAddress) => {
    return new TransactionEvent(EventType.BLOCK, Network.MAINNET, {from: deployer}, {contractAddress: contractAddress}, [], null, null);
  };
